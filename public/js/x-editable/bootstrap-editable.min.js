...
(function(b) {
	...
	a.prototype = {
		...
		submit : function(g) {
			...
			this.isSaving = true;
			b
					.when(this.save(d)).done(b.proxy(function(e) {this.isSaving = false;
			...
			.extend(
					a.fn.editableContainer.Popup.prototype,
					{
						...
						innerCss : a.fn.popover
								&& a(a.fn.popover.defaults.template).find("p").length ? ".popover-content p"
								: ".popover-content",
						initContainer : function() {
						...
						setPosition : function() {
							(function() {
								...
								c = typeof this.options.placement === "function" ? this.options.placement
...
(function(g) {
	...
	h.prototype = {
		...
		place : function() {
			...
			var o = this.component ? this.component.parent().offset()
					: this.element.offset();
			var n = this.component ? this.component.outerHeight(true)
		...
		fill : function() {
			var F = new Date(this.viewDate), w = F.getUTCFullYear(), G = F
					.getUTCMonth(), A = this.o.startDate !== -Infinity ? this.o.startDate
					.getUTCFullYear()
					: -Infinity, E = this.o.startDate !== -Infinity ? this.o.startDate
					.getUTCMonth()
					: -Infinity, t = this.o.endDate !== Infinity ? this.o.endDate
					.getUTCFullYear()
					: Infinity, B = this.o.endDate !== Infinity ? this.o.endDate
					.getUTCMonth()
					...
					if (this.o.calendarWeeks) {
						var o = new Date(+I
								...
								* 86400000), r = new Date(+o
								+ (7 + 4 - o.getUTCDay()) % 7 * 86400000), p = new Date(
								+(p = k(r.getUTCFullYear(), 0, 1))
										+ (7 + 4 - p.getUTCDay()) % 7
										* 86400000), x = (r - p) / 86400000 / 7 + 1;
		...
		click : function(r) {
			...
			if (s.length == 1) {
				...
				case "th":
					...
					case "today":
						var o = new Date();
						o = k(o.getFullYear(), o.getMonth(), o.getDate(), 0, 0,
								0);
						this.showMode(-2);
		...
		showMode : function(n) {
			...
			this.picker.find(">div").hide().filter(
					".datepicker-" + i.modes[this.viewMode].clsName).css(
					"display", "block");
			this.updateNavArrows()
		}
	};
				...
				.each(function() {
					...
					if (!w) {
						...
						if (y.is(".input-daterange") || v.inputs) {
							...
							y.data("datepicker", (w = new m(this, g
									.extend(v, x))))
						} else {
...
(function(b) {
	...
	b.extend(a.prototype, {
		...
		render : function() {
			...
			if (this.options.clear) {
				this.$clear = b('<a href="#"></a>').html(this.options.clear)
						.click(b.proxy(function(c) {
							c.preventDefault();
							c.stopPropagation();
							this.clear()
						}, this));
				this.$tpl.parent().append(
						b('<div class="editable-clear">').append(this.$clear))
			}
		},
		value2html : function(d, c) {
...
(function(b) {
	...
	b.extend(a.prototype, {
		...
		value2input : function(c) {
			this.$input.val(c ? this.dpg.formatDate(c, this.parsedViewFormat,
					this.options.datepicker.language) : "");
			this.$tpl.bdatepicker("update")
		},
		input2value : function() {
	...
	a.defaults = b
			.extend(
					{},
					b.fn.editabletypes.date.defaults,
					{
					...
					b.prototype,
					{
						initPicker : function(c, d) {
							...
							this.options.datetimepicker = a.extend({},
									d.datetimepicker, c.datetimepicker, {
										format : this.options.viewformat
									});
						...
						render : function() {
							this.$input
									.datetimepicker(this.options.datetimepicker);
							...
							if (this.options.clear) {
								this.$clear = a('<a href="#"></a>').html(
										this.options.clear).click(
										a.proxy(function(c) {
											c.preventDefault();
											c.stopPropagation();
											this.clear()
						...
						value2str : function(c) {
							return c ? this.dpg.formatDate(this.toUTC(c),
									this.parsedFormat,
									this.options.datetimepicker.language,
									this.options.formatType) : ""
						},
						...
						toUTC : function(c) {
							return c ? new Date(c.valueOf()
									- c.getTimezoneOffset() * 60000) : c
						},
						fromUTC : function(c) {
							return c ? new Date(c.valueOf()
									+ c.getTimezoneOffset() * 60000) : c
...
(function(b) {
	...
	a.defaults = b
			.extend(
					{},
					b.fn.editabletypes.datetime.defaults,
					{
						tpl : '<div class="input-append date"><input type="text"/><span class="add-on"><i class="icon-th"></i></span></div>',
						inputclass : "input-medium",
						datetimepicker : {
	...
	a.extend(b.prototype, {
		...
		input2value : function() {
			if (this.getIsObjects()) {
				...
				if (c.length
						&& c[0].text.toLowerCase() === this.$input.val()
								.toLowerCase()) {
					return d
				} else {
					return null
		...
		matcher : function(c) {
			return a.fn.typeahead.Constructor.prototype.matcher.call(this,
					c.text)
		},
		sorter : function(e) {
			var f = [], d = [], c = [], g, h;
		...
		highlighter : function(c) {
			return a.fn.typeahead.Constructor.prototype.highlighter.call(this,
					c.text)
		},
		updater : function(c) {
